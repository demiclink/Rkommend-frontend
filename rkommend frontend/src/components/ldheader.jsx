...
const LDheader = ({ className, indicator }) => {
  return (
    <div className="ld-headerdiv">
      <div className="ld-headerdiv__logodiv">
        ...
        <div className="ld-headerdiv__logodiv--status">LECTURER</div>
      </div>
      ...
      <Link to="/home-lecturer-notifications" className="no-underline">
        <button className={` ${"ld-notif__btn"} ${className}`}>
          <div className={`ld-notif__btn--indicator ${indicator} `}></div>{" "}
